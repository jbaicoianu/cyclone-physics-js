...
## History
Initially based on the [Cyclone Physics Engine](https://github.com/idmillington/cyclone-physics) as discussed in the book [Game Physics Engine Design](https://www.r-5.org/files/books/computers/algo-list/realtime-3d/Ian_Millington-Game_Physics_Engine_Development-EN.pdf), the engine has evolved significantly since its initial implementation. I wrote this physics engine to handle physics for Elation Engine back in 2011, after I outgrew the physics engine I'd written in 2008 to power a physically-simulated JavaScript UI toolkit for mobile phones of the time (eg, iPhone 3). At the time, there were few if any options for 3d physics on the web. It's now primarily used to provide physics to the JanusWeb virtual world client.

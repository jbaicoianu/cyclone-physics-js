...
describe('sphere-capsule collisions', function() {

  let tests = [
    {
      bodies: [
        { mass: 1, collider: 'sphere', collider_args: { radius: 1 }, position: new cyclone.vector3(-10, 0, 0), velocity: new cyclone.vector3(1, 0, 0) },
        { mass: 1, collider: 'capsule', collider_args: { radius: 1, length: 1 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(-1, 0, 0) },
      ],
    },
    {
      bodies: [
        { mass: 1, collider: 'sphere', collider_args: { radius: 1 }, position: new cyclone.vector3(-10, 0, 0), velocity: new cyclone.vector3(10, 0, 0) },
        { mass: 1, collider: 'capsule', collider_args: { radius: .1, length: .2 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(0, 0, 0) },
      ],
    },
    {
      bodies: [
    ...
    },
    {
      bodies: [
        ...
        { mass: 1, collider: 'capsule', collider_args: { radius: 3, length: .5 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(-1, 0, 0) },
      ],
    },
    {
      bodies: [
        ...
        { mass: 1, collider: 'capsule', collider_args: { radius: 1, length: .3 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(0, 0, 0) },
      ],
    },
    {
      bodies: [
        ...
        { mass: 1, collider: 'capsule', collider_args: { radius: .5, length: .9 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(0, 0, 0) },
      ],
    },
    {
      bodies: [
        ...
        { mass: 1, collider: 'capsule', collider_args: { radius: 1, length: 4 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(-1, 0, 0) },
      ],
    },
    {
      bodies: [
        ...
        { mass: 1, collider: 'capsule', collider_args: { radius: 1, length: 1 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(0, 0, 0) },
      ],
    },
    {
      bodies: [
    ...
    },
    {
      ...
      bodies: [
        ...
        { mass: 0.25, collider: 'capsule', collider_args: { radius: 0.232, length: .7 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(0, 0, 0) },
      ],
    },
    {
      seconds: 20,
      bodies: [
        ...
        { mass: 0.25, collider: 'capsule', collider_args: { radius: 1, length: 4 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(0, 0, 0) },
      ],
    },
    {
      bodies: [
        ...
        { mass: 0.25, collider: 'capsule', collider_args: { radius: 1, length: 100 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(-290, 0, 0) },
      ],
    },
    {
      bodies: [
        { mass: 0.2, collider: 'sphere', collider_args: { radius: 0.001 }, position: new cyclone.vector3(-10, 0, 0), velocity: new cyclone.vector3(10, 0, 0) },
        { mass: 0.25, collider: 'capsule', collider_args: { radius: 1, length: -2 }, position: new cyclone.vector3(10, 0, 0), velocity: new cyclone.vector3(0, 0, 0) },
      ],
    },
  ];
  tests.forEach(test => {
    ...
    it(`${obj1.collider}(${obj1.mass > 0 ? obj1.mass + 'kg mass' : 'static'}, ${obj1.collider_args.radius}m radius, ${obj1vel == 0 ? 'stationary' : 'moving ' + obj1vel + 'm/s'}) vs ${obj2.collider}(${obj2.mass > 0 ? obj2.mass + 'kg mass' : 'static'}, ${obj2.collider_args.radius}m radius, ${obj2.collider_args.length}m length, ${obj2vel == 0 ? 'stationary' : 'moving ' + obj2vel + 'm/s'})`, function(done) {

/**
 * Parameterized cylinder-sphere collision tests.
...
describe('Cylinder-Sphere collisions (parameterized)', () => {
  runCollisionScenarios(generateScenarios('cylinder', 'sphere', 500, randRange));
});

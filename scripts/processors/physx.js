...
/**
 * PhysXPhysicsProcessor - adapter for the NVIDIA PhysX library (WASM port)
 * @extends PhysicsProcessor
 */
class PhysXPhysicsProcessor extends PhysicsProcessor  {
  constructor(args={}) {
    super(args);
    this.path = args.path || '';
...
/**
 * PhysxWrapper - internal wrapper for PhysxPhysicsProcessor
 * @extends PhysicsProcessor
 */
class PhysXWrapper {
